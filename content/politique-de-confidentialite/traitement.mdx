  ...
  <div class="fr-table fr-table--no-caption">
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td>&lt;Renseigner le nom du service&gt;</td>
          <td>&lt;Pays d’origine du service&gt;</td>
          <td>
            &lt;Si le service permet de changer la localisation du stockage ou du transit des données, le préciser&gt;
          </td>
          <td>&lt;Renseigner le type service (Hébergement, bdd, etc.)&gt;</td>
          <td>
            <a
              href="<Ajouter le lien de la politique de confidentialité du service>"
              rel="noopener noreferrer"
              target="_blank"
            >
              &lt;Ajouter le lien de la politique de confidentialité du service&gt;
            </a>
          </td>
        </tr>
      </tbody>
...
Vous pouvez à tout moment retirer votre consentement relatif aux cookies en cliquant sur le bouton suivant : <span style={{color: "red"}}>[insérer bouton du Gestionnaire de Consentement]</span>
