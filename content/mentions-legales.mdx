...
Il est précisé aux utilisateurs du site [<span style={{color: "red"}}>indiquer l’adresse de votre site web</span>] l'identité des différents intervenants dans le cadre de sa réalisation et de son suivi.

### 1.1. Propriétaire et éditeur

Conformément aux dispositions de l’article 6-I 1° de la loi n°2004-575 du 21 juin 2004 relative à la confiance dans l’économie numérique, le site [<span style={{color: "red"}}>indiquer l’adresse de votre site web</span>] (et autres sites en ademe.fr, ci-après les “Sites”) est édité par l’ADEME, son siège social au :
...
Le directeur de la publication est M. Boris RAVIGNON, en qualité de représentant légal de l’ADEME.
...
Le prestataire assurant le stockage direct du site [<span style={{color: "red"}}>indiquer l’adresse de votre site web: ex. www.ademe.fr </span>] est Scalingo, dont le siège social est situé :

13 rue Jacques Peirotes <br></br>
67000 Strasbourg. <br></br>
Directeur de publication : Yann Klis.

### 1.4. Utilisateur

L’utilisateur est l’internaute qui navigue, lit, visionne, et utilise le site [<span style={{color: "red"}}>indiquer l’adresse de votre site web</span>] et ses services.

### 1.5. Attribution tierce

Certaines illustrations sont réalisées par [Storyset](https://storyset.com/). 

<span style={{color: "red"}}>FONCTIONNALITE ADDITIONNELLES</span>
...
Des cookies sont utilisés sur les Sites pour différentes finalités : pour faciliter votre navigation, pour vous proposer des contenus personnalisés ou pour réaliser des statistiques de visites. Pour connaître notre politique des cookies, cliquez sur /politique-des-cookies [<span style={{color: "red"}}>insérer le lien correspondant</span>].

## 7. Propriété intellectuelle

Sauf mentions contraires précisées sur le fichier <span style={{color: "red"}}>https://github.com/incubateur-ademe/facili-tacct/LICENSE</span>, l’ADEME est propriétaire des droits de propriété intellectuelle ou détient les droits d’usage sur tous les éléments accessibles sur le site, notamment les textes, images, graphismes, logos, icônes, sons, logiciels et marques déposées.
...
Pour en savoir plus sur ce traitement de données à caractère personnel et sur l’étendue de leurs droits, cliquez sur /politique-de-confidentialite [<span style={{color: "red"}}>insérer le lien correspondant</span>].
