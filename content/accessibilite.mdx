...
Cette déclaration d’accessibilité s’applique au site www.facili-tacct.beta.gouv.fr

## ÉTAT DE CONFORMITÉ

En l’absence d’audit et dans l’attente de celui-ci, le site www.facili-tacct.beta.gouv.fr n’est pas en conformité avec le référentiel général d’amélioration de l’accessibilité. Les non-conformités et/ou les dérogations sont énumérées ci-dessous.
