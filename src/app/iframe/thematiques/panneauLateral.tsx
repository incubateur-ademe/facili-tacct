              ...
              <div className="h-full">
                ...
                <BoutonPrimaireClassic
                  ...
                  onClick={() => {
                    ...
                    if (code) router.push(`/iframe/donnees?code=${code}&libelle=${libelle}&type=${typeTerritoire}&thematique=${thematique.link}`);
                    else router.push(`/iframe/donnees?libelle=${libelle}&type=${typeTerritoire}&thematique=${thematique.link}`);
                  }}
                />
              </div>
            )}
