      ...
      {data.map((element, i) =>
        element.disabled ? (
          ...
          <button
            ...
            disabled={element.disabled}
            className={
              selectedTabId === element.titre ? styles.selectedTab : styles.tab
            }
            onClick={() => {
              handleClick(element.titre);
            }}
...
export const TabCompNouveauParcours = ({ defaultTab, data, handleTab }: Props) => {
  const [selectedTabId, setSelectedTabId] = useState(defaultTab);
      ...
      {data.map((element, i) =>
        element.disabled ? (
          <HtmlTooltip title="Bientôt disponible" key={i}>
            <div>
              <button
                ...
                className={
                  selectedTabId === element.titre
                    ? styles.selectedTabNouveauParcours
                    : styles.disabledTab
                }
                onClick={() => {
                  handleClick(element.titre);
          ...
          <button
            ...
            disabled={element.disabled}
            className={
              selectedTabId === element.titre ? styles.selectedTabNouveauParcours : styles.tabNouveauParcours
            }
            onClick={() => {
              handleClick(element.titre);
            }}
