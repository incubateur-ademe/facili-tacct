  ...
  return isLoading ? (
    ...
    <div className={styles.explorerMesDonneesContainer}>
      ...
      <H1 style={{ color: 'var(--principales-vert)', fontSize: '2rem' }}>
        Les pressions sur la biodiversité agissent en silence, mais leurs
        conséquences sont durables. À vous d’en évaluer l’impact pour préserver
        la résilience de vos écosystèmes.
      </H1>
      {/* Introduction */}
      <section>
        <Body size="lg">
      ...
      <section className={styles.sectionType}>
        <H2 style={h2SectionStyle}>
          {ongletsMenu.thematiquesLiees[3].icone}{' '}
            ...
            boundingBox={
              coordonneesCommunes
                ? [
                  ...
                  [
                    coordonneesCommunes.bbox.maxLng,
                    coordonneesCommunes.bbox.maxLat
                  ]
                ]
                : undefined
            }
      ...
      <section className={styles.sectionType}>
        <H2 style={h2SectionStyle}>
          {ongletsMenu.thematiquesLiees[4].icone}{' '}
        ...
        <div id="Ozone et végétation" className={styles.indicateurMapWrapper}>
          <div className={styles.h3Titles}>
            <H3
              style={{ color: 'var(--principales-vert)', fontSize: '1.25rem' }}
            >
              Concentration d’ozone pendant la période de végétation (moyenne
              2020-2024)
            </H3>
          </div>
          <OzoneEtVegetation
