...
export const SeuilsReglementairesO3Ter = ({
  coordonneesCommunes
}: {
  ...
  useEffect(() => {
    ...
    map.on('load', () => {
      ...
      // Charger le GeoJSON par commune
      map.addSource('o3-source', {
        type: 'geojson',
        data: 'https://facili-tacct-dev.s3.fr-par.scw.cloud/app/seuils_reglementaires_o3/test_o3_cellules_par_commune.geojson'
      });
