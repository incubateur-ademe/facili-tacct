    ...
    <div>
      ...
      <div>
        ...
        <div style={{backgroundColor: "white", padding:"1em", borderRadius:"5px", margin:"0.5em 0"}}>
          ...
          En France en 2003, une surmortalité significative a été observée à partir de la classe d'âge 35-44 ans chez les hommes (+27%) 
          et 45-54 chez les femmes (+23%) <cite>[Hémon, D., Jougla, E. (2004). Surmortalité liée à la canicule d’août 2003. 
            Rapport remis au Ministre de la Santé et de la Protection Sociale, INSERM, 76p.]</cite>.
        </div>
        <div style={{backgroundColor: "white", padding:"1em", borderRadius:"5px", margin:"0.5em 0"}}>
          L'exposition à la chaleur en dehors des périodes de canicules présente un risque plus faible mais plus fréquent. Son impact sur la surmortalité totale est 
          plus important que celui des vagues de chaleur extrêmes qui sont plus dangereuses mais plus rares.
        </div>
        <div style={{backgroundColor: "white", padding:"1em", borderRadius:"5px", margin:"0.5em 0"}}>
