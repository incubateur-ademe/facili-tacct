  ...
  return (
    <div>
      ...
      <div className={styles.introduction}>
        <p>
          Dans le cadre du diagnostic de vulnérabilité engager les parties
          prenantes avant la restitution est essentiel. Par manque d’implication
          des parties prenantes lors de sa production, son contenu ne débouche
          pas sur la mise en place d’une stratégie d’adaptation à la hauteur des
          enjeux.
        </p>
        <p>
          En réponse, nous vous proposons l’atelier mémoire de territoire pour
          déterminer collectivement l’exposition du territoire aux aléas
          climatiques en partant de la connaissance des évènements passés et des
          probabilités d’occurrences futures. La liste se construit grâce aux
          arrêtés Cat Nat et aux parties prenantes du territoire. L’atelier
          permet d’engager vos parties prenantes en les positionnant dans un
          rôle de réelle contribution au diagnostic de vulnérabilité.
        </p>
        <div className={styles.blueWrapper}>
          ...
          <div className={styles.content}>
            ...
            <p>
              Élus, services techniques et experts dans la connaissance du
              territoire
            </p>
          </div>
        </div>
      ...
      <div className={styles.conseils}>
        <div className={styles.animation}>
          ...
          <ul className="mx-12">
            <li>Natoque penatibus et magnis dis parturient montes ;</li>
        ...
        <div className={styles.vigilance}>
          ...
          <ul className="mx-12">
            <li>
              S’assurer que les acteurs en présence aient une bonne vision de
              l’historique du territoire ;
            </li>
            <li>
              Mêler les points de vues et des expertises différentes en
              associant aussi différents acteurs du territoire (société civile,
              organisations privées, etc.)
            </li>
            <li>
              Bien expliquer l’objectif de l’atelier et s’assurer que les
              acteurs aient bien compris comment les résultats seront utilisés.
            </li>
            <li>
              Pour mobiliser dans la durée, captez des retours des
              participant-es, ils serviront pour améliorer votre déroulé, etc.
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className={styles.grayWrapper}>
        ...
        <ul className="mx-12">
          <li>
            Synthétisez les résultats et poursuivre via un travail sur
            l’exposition future de votre territoire ;
          </li>
          <li>
            Si vous utilisez la plateforme TACCT ajouter vos résultats sur la
            plateforme pour conserver les connaissances ;
          </li>
          <li>
          ...
          <li>
            Garder contact avec les participants pour les informer de l’avancée
            et les garder mobilisé ;
          </li>
          <li>Organiser un atelier sur la sensibilité</li>
          <li>
            Consulter la plateforme TACCT pour comprendre les prochaines étapes
            pour créer une démarche d’adaptation au changement climatique de
            votre territoire.
          </li>
        </ul>
      </div>
