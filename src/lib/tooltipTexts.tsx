...
export const fragiliteEconomiqueTooltipText = (
  <Body weight="bold" size="sm">La précarité énergétique liée au logement concerne :
    <br></br>
    <ul>
      <li>les ménages des 3 premiers déciles(*) c'est-à-dire les 30 % de la
        population ayant les revenus les plus modestes,</li>
      <li>parmi ces 30 %, les ménages qui consacrent plus de 8 % de leurs
    ...
    <ul>
      ...
      <li>
        <Body weight="bold" size="sm">les superficies en conversion (la durée de conversion variant de 2
          ...
          données en provenance d’un organisme certificateur).</Body>
      </li>
    </ul>
...
export const etatCoursDeauTooltipTextBiodiv = (
  <Body weight='bold' size="sm">
    ...
    <ul>
      <li><Body weight="bold" size="sm">température et acidité de l’eau,</Body></li>
      <li><Body weight="bold" size="sm">bilan de l’oxygène,</Body></li>
      <li><Body weight="bold" size="sm">hydro-morphologie du cours d’eau,</Body></li>
      <li>
        <Body weight="bold" size="sm">présence de poissons, de plantes aquatiques, de microalgues, de
...
export const feuxForetTooltipText = (
  <Body weight='bold' size="sm">
    ...
    <ul>
      <li>
        <Body weight="bold" size="sm">estimées (renseignées dans la BDIFF sans être issues de mesures),</Body>
      </li>
      <li>
        <Body weight="bold" size="sm">mesurées (issues de mesures sur le terrain ou d’un Système
