  ...
  return [
    {
      ...
      count: Sum(
        surfacesAgricoles.map((el) => el.superficie_sau_cultures_permanentes)
      ),
      color: '#00C190',
      value:
        (100 *
    ...
    },
    {
      ...
      color: '#009ADC',
      value:
        (100 * Sum(surfacesAgricoles.map((el) => el.superficie_sau_herbe))) /
        sommeToutesSuperficies
    },
    {
      id: 'Terres arables',
      count: Sum(
        surfacesAgricoles.map((el) => el.superficie_sau_terres_arables)
      ),
      color: '#7A49BE',
      value:
        (100 *
