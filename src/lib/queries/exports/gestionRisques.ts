...
export const fetchGestionRisquesForExport = async (
  ...
  try {
    ...
    const feuxForet = feuxForetRaw.map((item) => ({
      ...
      autres_surfaces_naturelles_hors_foret_km2: item.autres_surfaces_naturelles_hors_foret,
      surfaces_agricoles_km2: item.surfaces_agricoles,
      surfaces_non_boisees_km2: item.surfaces_non_boisees,
      surfaces_non_boisees_artificialisees_km2: item.surfaces_non_boisees_artificialisees,
    ...
    const rga = rgaRaw.map((item) => ({
      ...
      nb_logement_alea_moyen_fort_avant_1920: item.nb_logement_alea_moyen_fort_avant_1920,
      nb_logement_alea_moyen_fort_1920_1945: item.nb_logement_alea_moyen_fort_1920_1945,
      nb_logement_alea_moyen_fort_1945_1975: item.nb_logement_alea_moyen_fort_1945_1975,
      nb_logement_alea_moyen_fort_apres_1975: item.nb_logement_alea_moyen_fort_apres_1975,
      nb_logement_alea_faible_avant_1920: item.nb_logement_alea_faible_avant_1920,
      ...
      nb_logement_alea_faible_apres_1975: item.nb_logement_alea_faible_apres_1975,
      ...
      part_logement_alea_moyen_fort_avant_1920: item.part_logement_alea_moyen_fort_avant_1920,
      part_logement_alea_moyen_fort_1920_1945: item.part_logement_alea_moyen_fort_1920_1945,
      part_logement_alea_moyen_fort_1945_1975: item.part_logement_alea_moyen_fort_1945_1975,
      part_logement_alea_moyen_fort_apres_1975: item.part_logement_alea_moyen_fort_apres_1975,
      part_logement_alea_faible_avant_1920: item.part_logement_alea_faible_avant_1920,
      part_logement_alea_faible_1920_1945: item.part_logement_alea_faible_1920_1945,
      part_logement_alea_faible_1945_1975: item.part_logement_alea_faible_1945_1975,
      part_logement_alea_faible_apres_1975: item.part_logement_alea_faible_apres_1975,
