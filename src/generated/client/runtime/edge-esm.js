...
var Va = {
  enabled:
    !Ri && Si == null && Ii !== 'dumb' && ((sn != null && sn !== '0') || Oi)
};
function V(e, t) {
...
var kn = class {
  ...
  Dn = (e) => {
    ...
    return (
      e.getConnectionInfo &&
        (n.getConnectionInfo = Hu(t, e.getConnectionInfo.bind(e))),
      n
    );
  },
  Gu = (e, t) => {
