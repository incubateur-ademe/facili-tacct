...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'clc_paris' | 'test' | 'test2'
  ...
  interface clc_parisFieldRefs {
    ...
    readonly geometry: FieldRef<"clc_paris", 'String'>
  }
  ...
  export type clc_parisWhereInput = {
    ...
    geometry?: StringNullableFilter<"clc_paris"> | string | null
  }
  ...
  export type clc_parisScalarWhereWithAggregatesInput = {
    ...
    geometry?: StringNullableWithAggregatesFilter<"clc_paris"> | string | null
  }
