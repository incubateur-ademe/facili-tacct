...
const PrelevementEauBarChart = (
  ...
  const collectiviteName = codgeo ? filteredRessourcesEau.filter(
    (obj) => obj.code_geographique === codgeo
  )[0].libelle_geographique : filteredRessourcesEau.filter(
    (obj) => obj.epci === codepci
  )[0].libelle_epci; 
