...
export const GrandAgeIsolement = (props: {
  ...
  const grandAgeIsolementMapped = inconfortThermique.map(grandAgeIsolementMapper);
  const grandAgeIsolementCommune = codgeo ? grandAgeIsolementMapped.filter(e => e.code_commune === codgeo) : null;
  const grandAgeIsolementEpci = grandAgeIsolementMapped.filter(e => e.epci === codepci);
  const grandAgeIsolementDptmt = grandAgeIsolementMapped;
  const grandAgeCollectivite = grandAgeIsolementCommune ? grandAgeIsolementCommune : grandAgeIsolementEpci;

  const yData = {
    over_80_1968_percent: (
      (100 * sumProperty(grandAgeCollectivite, "over_80_sum_1968")) /
      (sumProperty(grandAgeCollectivite, "to_80_sum_1968") + sumProperty(grandAgeCollectivite, "under_4_sum_1968"))
    ).toFixed(2),
    over_80_1975_percent: (
      (100 * sumProperty(grandAgeCollectivite, "over_80_sum_1975")) /
      (sumProperty(grandAgeCollectivite, "to_80_sum_1975") + sumProperty(grandAgeCollectivite, "under_4_sum_1975"))
    ).toFixed(2),
    over_80_1982_percent: (
      (100 * sumProperty(grandAgeCollectivite, "over_80_sum_1982")) /
      (sumProperty(grandAgeCollectivite, "to_80_sum_1982") + sumProperty(grandAgeCollectivite, "under_4_sum_1982"))
    ).toFixed(2),
    over_80_1990_percent: (
      (100 * sumProperty(grandAgeCollectivite, "over_80_sum_1990")) /
      (sumProperty(grandAgeCollectivite, "to_80_sum_1990") + sumProperty(grandAgeCollectivite, "under_4_sum_1990"))
    ).toFixed(2),
    over_80_1999_percent: (
      (100 * sumProperty(grandAgeCollectivite, "over_80_sum_1999")) /
      (sumProperty(grandAgeCollectivite, "to_80_sum_1999") + sumProperty(grandAgeCollectivite, "under_4_sum_1999"))
    ).toFixed(2),
    over_80_2009_percent: (
      (100 * sumProperty(grandAgeCollectivite, "over_80_sum_2009")) /
      (sumProperty(grandAgeCollectivite, "to_80_sum_2009") + sumProperty(grandAgeCollectivite, "under_4_sum_2009"))
    ).toFixed(2),
    over_80_2014_percent: (
      (100 * sumProperty(grandAgeCollectivite, "over_80_sum_2014")) /
      (sumProperty(grandAgeCollectivite, "to_80_sum_2014") + sumProperty(grandAgeCollectivite, "under_4_sum_2014"))
    ).toFixed(2),
    over_80_2020_percent: (
      (100 * sumProperty(grandAgeCollectivite, "over_80_sum_2020")) /
      (sumProperty(grandAgeCollectivite, "to_80_sum_2020") + sumProperty(grandAgeCollectivite, "under_4_sum_2020"))
    ).toFixed(2),
    over_80_2020_percent_epci: (
      (100 * sumProperty(grandAgeIsolementEpci, "over_80_sum_2020")) /
      (sumProperty(grandAgeIsolementEpci, "to_80_sum_2020") + sumProperty(grandAgeIsolementEpci, "under_4_sum_2020"))
    ).toFixed(2),
    over_80_2020_percent_dptmt: (
      (100 * sumProperty(grandAgeIsolementDptmt, "over_80_sum_2020")) /
      (sumProperty(grandAgeIsolementDptmt, "to_80_sum_2020") + sumProperty(grandAgeIsolementDptmt, "under_4_sum_2020"))
    ).toFixed(2),
  };
          ...
          <div className="w-2/5">
            <div className={styles.explicationWrapper}>
              { codgeo ?
                <p style={{color: "#161616", margin:"0 0 0.5em"}}>
                  En 2020, <b>{yData.over_80_2020_percent}%</b> de la population de votre collectivité est constitué de personnes âgées de plus de 80 ans 
                  (soit <b>{sumProperty(grandAgeCollectivite, "over_80_sum_2020")}</b> personnes).
                  <br></br>
                  Ce taux est de <b>{yData.over_80_2020_percent_epci}%</b> dans votre EPCI.
                </p>
                : 
                <p style={{color: "#161616", margin:"0 0 0.5em"}}>
                  En 2020, <b>{yData.over_80_2020_percent}%</b> de la population de votre collectivité est constitué de personnes âgées de plus de 80 ans 
                  (soit <b>{sumProperty(grandAgeCollectivite, "over_80_sum_2020")}</b> personnes). 
                  <br></br>
                  Ce taux est de <b>{yData.over_80_2020_percent_dptmt}%</b> dans votre département.
                </p>
              }
            ...
            <div className="px-4">
              <p>
                ...
                <br></br>Le corps des personnes âgées régule moins bien la température, ce qui les rend plus sensibles aux fortes chaleurs. 
                Elles ressentent également moins la soif, ce qui augmente les risques de déshydratation. S'ajoutent souvent des problèmes de santé chroniques, 
                comme les maladies cardiovasculaires ou respiratoires, aggravés par la chaleur.
              </p>
              <p>
                Cette vulnérabilité est exacerbée par plusieurs facteurs : précarité énergétique, isolement social, et conditions de logement inadéquates. 
                Plus ces facteurs se cumulent, plus le risque d’une surmortalité en période de chaleur augmente. 
                Ces conditions créent un "cercle vicieux" qui accroît leur fragilité face à l’inconfort thermique. 
              </p>
              <p>
