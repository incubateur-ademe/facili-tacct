    ...
    { epci_chosen ? 
      ...
      >
        <GridCol lg={5}>
          ...
          <h4>EXPLICATION</h4>
          <div>
            <p>La sensibilité de la population est généralement estimée au regard de facteurs démographique, social ou culturel.</p>
            <ul style={{fontSize:'16px'}}>
             ...
             <p>Un tiers de la surmortalité attribuable aux périodes de fortes chaleurs concerne des personnes de moins de 75 ans.</p>
          </div>
        </GridCol>
        <GridCol lg={6}>
