...
//   // const surfaceTerritoire = code
//   //   ? carteCommunes.filter((e) => e.code_geographique === code)[0].surface
//   //   : carteCommunes.map((el) => el.surface).reduce((a, b) => a + b, 0);
//   // const filteredData = code
//   //   ? surfacesProtegees.filter((e) => e.code_geographique === code)
//   //   : surfacesProtegees;
