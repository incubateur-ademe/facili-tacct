          ...
          {agricultureBio[0] ? (
            <div className={styles.container}>
              <div className="w-1/2">
                <div className={styles.explicationWrapper}>
                  {codgeo ? (
                    <p style={{ color: '#161616', margin: '0 0 0.5em' }}>
                      Cette données n’est disponible qu’à l’échelle de votre
                      EPCI. <br></br>
                      Dans votre EPCI,{' '}
                      <b>{nombreExploitations} exploitations</b> sont en
                      agriculture biologique ou en conversion, représentant un
                      total de <b>{Round(surfaceAgriBio, 0)} hectares</b>.
                    </p>
                  ) : (
                    <p style={{ color: '#161616', margin: '0 0 0.5em' }}>
                      Dans votre EPCI,{' '}
                ...
                <div className="px-4">
                  <p>
                    L'effondrement de la biodiversité n’est pas une fiction :
                    69 % des espèces sauvages ont disparu à l'échelle de la
                    planète entre 1970 et 2018, du fait notamment de la
                    dégradation ou de la disparition de leurs habitats naturels.
                    L’agriculture dispose de deux leviers complémentaires de
                    protection de la biodiversité : adopter des pratiques moins
                    intensives et favoriser la diversité des paysages. Les
                    cultures à bas niveau d’intrants, la non-utilisation de
                    produits chimiques de synthèse, la non-utilisation d'OGM, le
                    recyclage des matières organiques, la rotation des cultures
                    et la lutte biologique participent à ces deux objectifs.
                  </p>
                  <p>
                    Si l’agriculture biologique n’est pas une solution parfaite,
                    elle reste aujourd’hui l’une des meilleures réponses, aux
                    côtés des pratiques à bas-intrants, pour préserver la
                    biodiversité. Alors que 70 % des sols agricoles sont
                    dégradés en Europe, ses effets positifs sur la vie
                    souterraine sont avérés. Des écosystèmes renforcés sont des
                    écosystèmes plus résilients aux impacts du changement
                    climatique.
                  </p>
                  <p>
                    ⇒ Une biodiversité plus riche dans les parcelles en
                    agriculture biologique : +32 % d'individus et +23 %
                    d'espèces par rapport à l’agriculture conventionnelle.
                  </p>
                  <p>
                    ⇒ 70 % des indicateurs biologiques des sols s'améliorent
                    après conversion.
                  </p>
                  <p>
                  ...
                  <p>
                    ⇒ Une meilleure résistance à la sécheresse : disponibilité
                    en eau dans les sols améliorée de 4 % à 45 %.
                  </p>
                  <p>
                    ⇒ Jusqu'à 35 % de carbone supplémentaire stocké dans les
                    sols.
                  </p>
                </div>
              </div>
