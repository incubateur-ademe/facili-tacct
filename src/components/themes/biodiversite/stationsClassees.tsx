              ...
              <div className={styles.legend}>
                <div className={styles.legendStationWrapper}>
                  <div className={styles.legendItem}>
                    <Image src={markerIcon as StaticImageData} alt="" width={16} />
                    <p>Station</p>
                  </div>
                </div>
                <div className={styles.legendItemsWrapper}>
                  <div className={styles.legendItem}>
                  <div className={styles.legendColor} style={{ backgroundColor: "#FFFF8C" }}></div>
                  <p>Artificialisé</p>
                  </div>
                  <div className={styles.legendItem}>
                  <div className={styles.legendColor} style={{ backgroundColor: "#FFBB7D" }}></div>
                  <p>Agricole</p>
                  </div>
                  <div className={styles.legendItem}>
                  <div className={styles.legendColor} style={{ backgroundColor: "#64CB77" }}></div>
                  <p>Végétalisé/semi-naturel</p>
                  </div>
                  <div className={styles.legendItem}>
                  <div className={styles.legendColor} style={{ backgroundColor: "#BFAED7" }}></div>
                  <p>Humide</p>
                  </div>
                  <div className={styles.legendItem}>
                  <div className={styles.legendColor} style={{ backgroundColor: "#206EB4" }}></div>
                  <p>Eau</p>
                  </div>
                </div>
              </div>
