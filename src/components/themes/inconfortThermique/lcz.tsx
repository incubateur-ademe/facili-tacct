        ...
        <div className={styles.container}>
          <div className="w-2/5">
            <div className={styles.explicationWrapper}>

              {
                isLczCovered ? (
                  ...
                  <>
                    ...
                    <p>
                      Cette carte, issue de multiples jeux de données d'observation
                      de la Terre, vous permet d'explorer votre territoire à 100 m
                      de résolution spatiale. Les zones climatiques locales (LCZ en anglais)
                      montrent comment un territoire réagit aux vagues de chaleur estivales.
              ...
              <CustomTooltip title={LCZTooltipText} texte="Que sont les LCZ ?" />
            </div>
            <LCZText />
          </div>
          <div className="w-3/5">
